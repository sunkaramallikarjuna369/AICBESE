# CBSE Learning Platform - Low-Cost Edition
...
**This is the Low-Cost Edition** optimized for deployment with minimal cloud costs using Firebase/Firestore and Replicate AI instead of Cloud SQL and Vertex AI.

## Cost Savings

| Component | Original | Low-Cost Edition | Savings |
|-----------|----------|------------------|---------|
| Database | Cloud SQL (~$10-50/mo) | Firebase/Firestore (FREE) | 100% |
| AI API | Vertex AI (~$5-50/mo) | Replicate (~$0.50-5/mo) | 90% |
| Compute | Cloud Run (always-on) | Cloud Run (scale-to-zero) | 100% |
...
- **Replicate AI (Llama 3.1)** integration for cost-effective content generation
- **Firebase/Firestore** for free-tier database and authentication
...
```bash
# For Mock (free, development/testing) - DEFAULT
export AI_PROVIDER=mock

# For Replicate (low-cost production) - RECOMMENDED
export AI_PROVIDER=replicate
export REPLICATE_API_TOKEN=r8_your_token_here
export REPLICATE_MODEL=meta/meta-llama-3.1-8b-instruct

# For Vertex AI (higher cost, requires GCP project)
...
- **[Ultra Low-Cost Guide](docs/ULTRA_LOW_COST_GUIDE.md)** - Comprehensive guide for deploying with minimal costs, including trial credits
- **[Low-Budget Deployment Guide](docs/LOW_BUDGET_DEPLOYMENT_GUIDE.md)** - Step-by-step deployment for beginners
- **[Cost Optimization Guide](docs/COST_OPTIMIZATION.md)** - Tips to minimize costs and stay within budget
- **[Budget Estimate](docs/BUDGET_ESTIMATE.md)** - Detailed cost breakdown for different scales
